const SITE_DATA = {
  ...
  "cost_breakdown": [
    {
      "component": "H.R.8034 military provisions: FMF, missile defense, CENTCOM ops, ammo (Apr 2024)",
      "source": "Congress.gov, CBO (military provisions only; excludes $9.15B in humanitarian aid for Gaza)",
      "estimate_usd": 17230000000,
      "estimate_label": "$17.23B"
    },
    {
    ...
    {
      "component": "FY2025 Foreign Military Financing for Israel (H.R.1968) — annual baseline under US-Israel MOU",
    ...
    {
      "component": "US equipment reported destroyed by Iranian retaliatory strikes: AN/FPS-132, AN/TPY-2 radars, SATCOM (Feb 28–Mar 4)",
      "source": "NYT satellite imagery, TRT World, Defence Security Asia (damage assessments ongoing)",
  ...
  "alternatives": [
    ...
    },
    {
      ...
      "label": "The entire annual EPA budget (~$6B), funded nearly 6× over",
  ...
  "events": [
    ...
    },
    {
      ...
      "class": "notable",
      "title": "$95B Foreign Aid Package — $17.23B in military provisions for Israel (H.R.8034)",
      "desc": "H.R.8034 allocated $26.38B for Israel within a $95B package. Of that, $17.23B was military: FMF ($3.5B), missile defense ($5.2B), CENTCOM ops ($6.8B), and ammunition ($0.8B). The remaining $9.15B was humanitarian aid for Gaza (excluded from this tracker).",
      "cost_note": "Military provisions: $17.23B · Full bill: $26.38B (incl. $9.15B humanitarian, not counted)",
      "sources": [
    ...
    },
    {
      ...
      "cumul_label": "~$18.4B–$19.9B",
      "class": "support",
      "title": "Operation Rough Rider: US airstrikes on Houthi forces in Yemen",
      "desc": "Sustained US air campaign against Houthi infrastructure in Yemen. The Houthis, an Iranian-backed proxy, had disrupted global shipping since late 2023. Strikes used Tomahawk missiles (~$2M each, Block V procurement unit cost), B-2 sorties, and carrier air wing operations.",
    ...
    },
    {
      ...
      "desc": "US and Israeli forces struck 1,000+ Iranian military sites in the first 24 hours. Weapons included B-2 bombers, Tomahawk missiles (~$2M each, Block V procurement unit cost), HIMARS rockets, and F-35C sorties. Supreme Leader Khamenei was killed. Three US service members were killed.",
    ...
    },
    {
      ...
      "cost_note": "3 F-15E airframes: ~$93M original / ~$282M replacement",
      "sources": [
    ...
    },
    {
      ...
      "class": "notable",
      "open": true,
      "title": "Satellite imagery shows Iran struck ~$1.9B in US radar/air defense infrastructure across 5 Gulf states",
      "desc": "NYT satellite imagery showed Iranian strikes hit US radar and communication systems across bases in Qatar, UAE, Kuwait, Bahrain, and Saudi Arabia. The AN/FPS-132 early warning radar at Al Udeid (~$1.1B) — the nerve center of US missile defense coordination — was hit by a single missile. Two AN/TPY-2 THAAD radars were reported destroyed in the UAE and Jordan. SATCOM terminals and radomes were damaged across multiple installations. Full damage assessments are ongoing; estimates may be revised as more information becomes available.",
      "cost_note": "AN/FPS-132: ~$1.1B · 2× AN/TPY-2: ~$500M each · SATCOM/radomes: additional · Total reported equipment losses: ~$1.9B",
      "sources": [
  ...
  "chart_annotations": [
    {
      "key": "hr8034",
      "date": "2024-04-20",
      "label": "$17.2B military aid (H.R.8034)",
